...
//Program to perform operations inside a Bank System
...
public class BankAccount {
	   ...
	   public static void main(String[] args) {
	       ...
	       BankAccount account1 = new BankAccount("Ayush Rathor", "ACC12345", 1000.00);
	       BankAccount account2 = new BankAccount("Danish Ali", "ACC67890", 500.00);
