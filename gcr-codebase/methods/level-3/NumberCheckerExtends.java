// Create NumberCheckerExtends class to check Harshad Number and digit frequency
import java.util.Scanner;

public class NumberCheckerExtends {
	...
	public static void main(String[] args) {
		...
		//Calling method to compute digit frequency
