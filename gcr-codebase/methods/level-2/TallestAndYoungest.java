...
public class TallestAndYoungest{
	...
	//Computing the youngest and tallest friend
	...
	//caling method to calculate the tallest and youngest friend
	int smallest = TallestAndYoungest.youngest(age);
	int tallest = TallestAndYoungest.tallest(height);
