...
// Program to convert image to byte array and write it back to file
public class ImageByteArrayApp {

    public static void main(String[] args) {

        String inputImage = "src\\com\\streams\\bytearray\\test.jpg";
        String outputImage = "src\\com\\streams\\bytearray\\copied.jpg";
