package com.map.insurancepolicy;
...
public class InsuranceApp {
	...
	public static void main(String[] args) {
		...
		// Creating policies
		Policy p1 = new Policy(201, "Arif Iqubal", LocalDate.now().plusDays(15), "Health", 12000);

		Policy p2 = new Policy(202, "Ravi Sharma", LocalDate.now().plusDays(45), "Auto", 8000);

		Policy p3 = new Policy(203, "Arif Iqubal", LocalDate.now().minusDays(5), "Home", 15000);
