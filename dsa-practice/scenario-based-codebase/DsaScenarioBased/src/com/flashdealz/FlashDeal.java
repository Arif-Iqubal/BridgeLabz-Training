...
public class FlashDeal {
	...
	static int listSize = 0; // Static variable to store size of Product
	static Product[] productList = new Product[listSize]; // Product array to store Product object
	...
	//Method to return the position of pivot value and perform partitions
