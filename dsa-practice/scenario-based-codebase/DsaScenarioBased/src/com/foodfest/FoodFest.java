...
public class FoodFest {
	...
	public static void displayInfo() {
		...
		for (int i = 0; i < stallList.length; i++) {
			System.out.println(stallList[i].stallName + "\t" + stallList[i].count + "\t" + stallList[i].zone);
		}
	}
